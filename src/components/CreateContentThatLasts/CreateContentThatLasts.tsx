  ...
  return (
    <div className="mx-[10vw] md:mt-64">
      ...
      <div className='flex flex-col md:flex-row mt-10 justify-between'>
          ...
          <div className='w-12/12 md:w-5/12 mt-6 md:mt-0 min-h-72 bg-[#16151c] relative overflow-hidden rounded-3xl border border-x-violet-400 border-y-indigo-500'>
            <img className='absolute mt-20 ml-32' src={Infinity} alt="For ever." />
            <p className='relative p-6 font-display text-2xl md:text-3xl'>Your posts stay on the blockchain forever if you mint them as NFTs</p>
